    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('account.list')}}" class="nav-link @if(Request::segment(2) == 'admin') active @endif">
          ...
          <li class="nav-item">
            <a href="{{route('delivery.list')}}" class="nav-link @if(Request::segment(2) == 'delivery') active @endif">
              <i class="nav-icon fab fa-product-hunt"></i>
              <p>
                Vận chuyển
              </p>
          ...
          <li class="nav-item">
            <a href="{{route('payment.list')}}" class="nav-link @if(Request::segment(2) == 'payment') active @endif">
              <i class="nav-icon fab fa-product-hunt"></i>
              <p>
                Thanh toán
              </p>
          ...
          <li class="nav-item">
            <a href="{{route('order.list')}}" class="nav-link @if(Request::segment(2) == 'order') active @endif">
          ...
          <li class="nav-item">
            <a href="{{route('admin.logout')}}" class="nav-link @if(Request::segment(2) == 'logout') active @endif">
